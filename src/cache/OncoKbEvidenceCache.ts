        ...
        try
        {
            if (this.oncoKbClient.evidencesLookupPostUsingPOST)
            {
                const evidenceLookup = await this.oncoKbClient.evidencesLookupPostUsingPOST({
                    body: {
                        ...generatePartialEvidenceQuery("STANDARD_THERAPEUTIC_IMPLICATIONS_FOR_DRUG_SENSITIVITY,STANDARD_THERAPEUTIC_IMPLICATIONS_FOR_DRUG_RESISTANCE,INVESTIGATIONAL_THERAPEUTIC_IMPLICATIONS_DRUG_SENSITIVITY,INVESTIGATIONAL_THERAPEUTIC_IMPLICATIONS_DRUG_RESISTANCE"),
